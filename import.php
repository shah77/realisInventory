...
<div class="container">
     <div class="sidebar">
         <ul class="nav">
             ...
             <li class="current"><a href="import.php"><img src="upload.png" width="14px">Import Data</a></li>
...
if(!empty($_GET['status'])){
    switch($_GET['status']){
        case 'succ':
            ...
            $statusMsg = '*Item data has been inserted successfully.';
            break;
        case 'err':
...
<div class="container">
    <?php if(!empty($statusMsg)){
        ...
        <div class="panel">
            Item list
            <a href="javascript:void(0);" onclick="$('#importFrm').slideToggle();" >Import now</a>
        </div>
        <div class="importcontainer">
        <div class="panel-body">
            <form action="importData.php" method="post" enctype="multipart/form-data" id="importFrm">
                <input type="file" name="file" />
                <input type="submit" class="button button-block" name="importSubmit" value="IMPORT">
            </form>
